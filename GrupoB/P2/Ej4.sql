...
insert Actores values (null, 'Margot Robbie',3053338 );
insert Actores values (null, 'Emma Watson', 0914612);
insert Actores values (null, 'Brad Pitt', 0000093);

insert Directores values (null, 'Quentin Tarantino', 0000233);
insert Directores values (null, 'Justin Lin', 0510912);
insert Directores values (null, 'Steven Spielberg', 0000229);
insert Directores values (null, 'Cristopher Nolan', 0634240);
insert Directores values (null, 'J.A Bayona', 1291105);
